...
<body class="font-sans bg-white">
  ...
  <!-- Sidebar -->
  <aside id="sidebar" class="fixed top-0 left-0 h-screen w-64 bg-gradient-to-b from-[#FFE6E1] to-[#F0BAAF] shadow-md transform -translate-x-full md:translate-x-0 transition-transform duration-300 z-50">
    <div class="flex flex-col h-full">
      <!-- Profil Dokter -->
      <div class="flex flex-col items-center py-4 border-b border-[#C04C4C]/30">
        <img src="https://i.pravatar.cc/80" alt="Profile" class="w-20 h-20 rounded-full border-4 border-white shadow-md">
      ...
      <nav class="flex-1 px-4 space-y-4 mt-4">
        ...
        <a href="reservasi" class="block text-[#C04C4C] font-semibold hover:text-[#a93d3d] transition">Reservasi</a>
        <a href="#" class="block text-[#C04C4C] font-semibold hover:text-[#a93d3d] transition">Navigasi</a>
        <a href="#" class="block bg-white text-[#C04C4C] font-semibold px-4 py-1 rounded-lg shadow hover:bg-[#FFE6E1] transition text-center">Logout</a>
      </nav>
    </div>
  </aside>
